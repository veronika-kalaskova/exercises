                ...
                <div className="flex justify-between">
                  ...
                  {popular === true && (
                    <div className="inline-flex text-sm px-4 py-1.5 border rounded-xl border-white/20">
                      <motion.span
                        className="bg-[linear-gradient(to_right,#DD7DFF,#E1CD86,#8BCB92,#71C2EF,#3BFFFF,#DD7DFF,#E1CD86,#8BCB92,#71C2EF,#3BFFFF)] [background-size:200%] text-transparent bg-clip-text font-medium"
                        animate={{
