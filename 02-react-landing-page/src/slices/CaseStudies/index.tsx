...
const CaseStudies = async ({
  ...
  // Fetching data from individual case study page (ex. all texts from Nike page)
  const caseStudies = await Promise.all(
    slice.primary.study.map(async (item) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 mx-auto max-w-md text-balance text-center text-slate-300">
          ...
          (caseStudy, index) =>
            caseStudy && (
              ...
              >
                ...
                <PrismicNextImage field={caseStudy.data.logo_image} quality={100} className={clsx("rounded-xl lg:col-span-2", index % 2 && "md:-order-1")}></PrismicNextImage>
              </div>
            ),
        )}
      </div>
